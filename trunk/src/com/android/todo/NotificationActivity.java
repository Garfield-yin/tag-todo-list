...
public final class NotificationActivity extends Activity {
		...
		statButton.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				Utils.showDialog(R.string.notification_view_info_short,
						R.string.notification_view_info_long,
	...
	public void onCreateContextMenu(ContextMenu menu, View v,
		...
		submenu
				.add(0, TagToDoList.ENTRY_AUDIO_ID, 0,
						R.string.entry_audio_note);
		submenu.add(0, TagToDoList.ENTRY_GRAPHICAL_ID, 0,
				R.string.entry_graphical_note);
		submenu.add(0, TagToDoList.ENTRY_WRITTEN_ID, 0,
				R.string.entry_written_note);
