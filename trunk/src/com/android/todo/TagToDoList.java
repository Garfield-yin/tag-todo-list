...
public class TagToDoList extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		mStatButton.setOnClickListener(new View.OnClickListener() {
			public void onClick(View view) {
				...
				String s = mDbHelper.countUncheckedEntries(mTagsArrayAdapter
	...
	private void selectTag(int selectedTag) {
		...
		CompoundButton.OnCheckedChangeListener ccl = new CompoundButton.OnCheckedChangeListener() {
			public void onCheckedChanged(CompoundButton buttonView,
					boolean isChecked) {
				mDbHelper.updateEntry(buttonView.getText().toString(),
						isChecked);
				selectTag(mTagSpinner.getSelectedItemPosition());
			}
		};
	...
	private boolean populateMenu(Menu menu) {
		MenuItem item1 = menu
				.add(0, TAG_INSERT_ID, 0, R.string.menu_create_tag);
	...
	public static final void importBackupSD() {
		...
		try {
			...
			Utils.showDialog(R.string.notification,
					R.string.backup_import_fail, mContext);
		}
	...
	private void populateFields() {
		...
		if (SYNC_GCAL = mSettings.getBoolean(ConfigScreen.GOOGLE_CALENDAR,
				false)) {
			GoogleCalendar.setLogin(mSettings.getString(
					ConfigScreen.GOOGLE_USERNAME, ""), mSettings.getString(
			...
			mTagSpinner
					.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
						public void onItemSelected(AdapterView<?> arg0,
							...
							mDbHelper.updateEntryParent(mContextEntry,
									mTagsArrayAdapter.getItem(arg2).toString());
