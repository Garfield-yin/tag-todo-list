...
public final class ConfirmationScreen extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (mTagName == null) {
			...
			mTagName = extras != null ? extras.getString(ToDoDB.KEY_NAME)
					: null;
		}
			...
			if (ll.getChildCount() < 3) {
				...
				ib.setOnClickListener(new OnClickListener(){
					public void onClick(View v) {
						...
						i.setData(Uri.parse("https://www.paypal.com/cgi-bin/webscr?cmd=_donations&business=TTVTAWLMS6AWG&lc=GB&item_name=Teo%27s%20free%20projects&currency_code=USD&bn=PP%2dDonationsBF%3abtn_donateCC_LG_global%2egif%3aNonHosted"));
						startActivity(i);
					}
				});
				ll.addView(ib, 0);
	...
	/**
	 * Intercepts a key press. A positive outcome (a confirmation) = RETURN or Y
	 * A negative outcome (a cancellation) = DEL or N
	 */
	public boolean onKeyDown(int keyCode, KeyEvent msg) {
		...
		case KeyEvent.KEYCODE_K:
			Utils.showDialog(R.string.keyboard_title,
					R.string.keyboard_help_text, ConfirmationScreen.this);
			break;
		}
		return false;
	}
